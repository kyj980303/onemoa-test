...
public class Contest {
  ...
  // 첨부파일 정보를 저장할 필드
  private List<ContestAttachedFile> attachedFiles;

  @Override
  public String toString() {
    return "Contest [ctstNo=" + ctstNo + ", orgNo=" + orgNo + ", ctgNo=" + ctgNo + ", title="
  ...
  public List<ContestAttachedFile> getAttachedFiles() {
    return attachedFiles;
  }

  public void setAttachedFiles(List<ContestAttachedFile> attachedFiles) {
